...
Komo is built using the following tech stack
...
See the [open issues](https://github.com/jupeeter8/Komo/issues) for a full list of proposed features (and known issues).
